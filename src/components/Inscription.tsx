    ...
    return(
        <div className="p-10">
            ...
            <div className="flex my-5 gap-15">
                <hr className="text-[#E4E4E7] w-55 h-1 mt-3"/>
            ...
            <div className="flex flex-col gap-5">
                <div className="flex gap-3 bg-[#FFFF] border border-[#E4E4E7] w-[20rem] h-10 rounded-[4px] text-[#18181B] justify-center items-center ">
                    <img src="/Vector(2).svg" alt="" />
                    <Button text="Github"/>
                </div>

                <div className="flex gap-4 bg-[#FFFF] border border-[#E4E4E7] w-[20rem] h-10 rounded-[4px] text-[#18181B] justify-center items-center ">
